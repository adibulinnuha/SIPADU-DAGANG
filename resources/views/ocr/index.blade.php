...
<div class="space-y-6">
        ...
        <form action="{{ route('ocr.process') }}"
            ...
            <div class="rounded-xl border-2 border-dashed border-slate-300 p-6">
                ...
                <div class="mt-5">
                    ...
                    <img id="preview"
                         class="hidden max-h-96 rounded-xl border shadow"
                         alt="Preview Tiket">
            ...
            <button type="submit"
                    ...
                    class="mt-5 rounded-lg bg-purple-600 px-6 py-3 font-semibold text-white hover:bg-purple-700">
    ...
    <div class="rounded-2xl border bg-white p-6 shadow-sm">
        ...
        <table class="w-full border-collapse">
            ...
            @foreach(session('ocr_result') as $key => $value)
                ...
                <tr class="border-b">
                    ...
                    <td class="w-1/3 p-3 font-semibold text-slate-600">
        ...
        <button class="mt-5 rounded-lg bg-emerald-600 px-6 py-3 text-white">
