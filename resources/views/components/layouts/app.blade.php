...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-white">
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="{{ route('retributions.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                💰 Retribusi Harian
            </a>

            <a href="{{ route('verifications.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                ✔️ Verifikasi Billing
            </a>

            <a href="{{ route('bendel.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                📄 Bendel
            </a>

            <a href="{{ route('reports.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                📈 Laporan & Rekap
            </a>

            <a href="{{ route('backup.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                💾 Backup Data
            </a>

            <a href="{{ route('settings.index') }}" class="block px-3 py-2 rounded hover:bg-slate-700">
                ⚙️ Pengaturan
            </a>
